...
FIRST_DAY = 1#750 # If you want to load all the data set it to '1' -->  Great  memory overflow  risk !

#print(time)

df = create_dt(is_train=True, first_day= FIRST_DAY)
df.to_pickle('m5_data_FIRST_DAY_1.pkl')
print('m5_data saved!')
df.shape
df.head()
...
sub.to_csv("m5_submission.csv",index=False)
